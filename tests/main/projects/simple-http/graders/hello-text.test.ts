...
import { helloTextGrader } from '../../../../../src/main/projects/simple-http/graders/hello-text';
import type { GraderResult } from '../../../../../src/shared/types';
import { server } from '../mocks';
import {
  badContentTypeHelloTextUrl,
  badHelloTextUrl,
  goodHelloTextUrl,
  httpErrorHelloTextUrl,
  networkErrorHelloTextUrl
} from '../mocks/hello-text-handlers';
